...
<head>
    <style>
        /* THEME: Antonino's Shop Master Style */
        body {
        ...
        .card { background: #141414; padding: 30px; border-radius: 15px; border: 1px solid #333; max-width: 800px; }
        h2 { color: #ff9d00; margin-top: 0; }

        input[type="date"], input[type="number"], input[type="file"] {
            width: 100%; padding: 12px; background: #222; border: 1px solid #444; color: white; border-radius: 6px; margin-bottom: 15px;
        }

        .save-btn { background: #ff9d00; color: black; border: none; padding: 15px; width: 100%; font-weight: bold; cursor: pointer; border-radius: 6px; }
    </style>
</head>
<body>
